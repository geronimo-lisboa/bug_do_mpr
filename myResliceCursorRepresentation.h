...
class VTKINTERACTIONWIDGETS_EXPORT myResliceCursorRepresentation : public vtkWidgetRepresentation
{
public:
  // Description:
  // Standard VTK methods.
	vtkTypeMacro(myResliceCursorRepresentation, vtkWidgetRepresentation);
...
private:
	myResliceCursorRepresentation(const myResliceCursorRepresentation&);  //Not implemented
	void operator=(const myResliceCursorRepresentation&);  //Not implemented
};
